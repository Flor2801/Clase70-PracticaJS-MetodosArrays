...
let solistas = artistas.filter((artista) => {
  return artista.solista = true
})

console.log(solistas)
...
let sobrevivientesClubDeLos27 = artistas.filter((artista) => {
  return artista.edad > 27
})

console.log(sobreviientesClubDeLos27)
...
let artistasConMasDiscosQue = artistas.sort (())
...
let artistaConMasEntradasVendidas = artistas.filter((artista) => {
...
let artistaConMayorRecaudacion = artistas.filter((vendedor) => {
  return artistas.entradasVendidas*
})
